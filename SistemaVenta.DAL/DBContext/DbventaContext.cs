...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C38C06E4F");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F5C5FDEE0");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF4839448D5FB");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A42498430D");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421A2656C53E");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1329DC5F0AA");
            ...
            object value = entity.HasOne(d => d.IdCategoriaNavigation).WithMany(p => p.Productos)
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6F1E587FC");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56142A5AC364");
